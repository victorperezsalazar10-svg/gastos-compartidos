...
public class GastoService {
    ...
    public List<DetalleGasto> obtenerDetalles(
            Long gastoId) {

        return detalleGastoRepository
    ...
    public Gasto guardar(GastoRequestDTO request) {
        ...
        switch (gasto.getTipoDivision()) {
            ...
            case IGUAL -> dividirIgual(gastoGuardado);

            case PORCENTUAL -> dividirPorcentual(
                    gastoGuardado,
                    request.getDetalles());

            case PERSONALIZADA -> dividirPersonalizada(
                    gastoGuardado,
                    request.getDetalles());
        }
